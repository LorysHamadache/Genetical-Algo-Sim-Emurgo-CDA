...
--
--
--update_characterG:: Character -> StateT Environment IO Character
--update_characterG c = do
--  start_env <-get
--  (end_c, end_env) <-  runStateT (lift $ update_character c) start_env
--  return $ end_c
--
--
...
--update_model m = do
--  let start_env = env m
--  (end_clist, end_env) <-  runStateT  (mapM (\x -> update_characterG x) (clist m)) start_env
